...
def skeletonize(
    ...
    batch_size : int, optional
        ...
        the entire volume at once. For large volumes, consider setting this to a specific
        value like 1,000,000 for efficient processing without exceeding memory limits.
    
    Examples
    --------
    membrain skeletonize --label-path <path> --out-folder <output-directory> --batch-size <batch-size>
    """
